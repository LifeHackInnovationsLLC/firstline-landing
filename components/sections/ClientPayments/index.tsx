...
const items = [
  { icon: <NoExtraWorkIcon />, label: "No extra work — just introduce, we close" },
  { icon: <RecurringIcon />, label: "Recurring commissions for the life of the account" },
  { icon: <BetterRatesIcon />, label: "Better rates than their current processor" },
  { icon: <WhiteGloveIcon />, label: "White-glove onboarding for your clients" },
];

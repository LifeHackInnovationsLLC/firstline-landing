...
function RecurringIcon() {
  return (
    ...
    >
      <path
        d="M1.625 14.75V11.25M1.625 11.25H5.125M1.625 11.25C2.83533 13.3423 5.15901 14.75 7.75 14.75C11.616 14.75 14.75 11.616 14.75 7.75M13.8854 0.75V4.25H10.3854M0.75 7.75C0.75 3.88401 3.88401 0.75 7.75 0.75C10.341 0.75 12.6647 2.15769 13.875 4.25"
        stroke="#51C9C2"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const items = [
  {
    icon: <NoExtraWorkIcon />,
    label: "No extra work — just introduce, we close",
  },
  {
    icon: <RecurringIcon />,
    label: "Recurring commissions for the life of the account",
  },
  {
    icon: <BetterRatesIcon />,
    label: "Better rates than their current processor",
  },
  {
    icon: <WhiteGloveIcon />,
    label: "White-glove onboarding for your clients",
  },
];
          ...
          <FeatureCardContent className="relative z-10">
            ...
            <StaggerGroup as="ul" className="mt-10 flex flex-col gap-3.5">
              {items.map((item) => (
                ...
                >
                  <span className="shrink-0 w-6 h-4 flex items-center justify-center mt-0.5">
                    {item.icon}
                  </span>
